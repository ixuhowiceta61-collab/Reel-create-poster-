...
export const FeaturedPosters: React.FC<FeaturedPostersProps> = ({
  ...
  const tabs = [
    { id: 'popular' as CollectionTab, labelBn: 'জনপ্রিয় পোস্টার', icon: Flame },
    { id: 'new' as CollectionTab, labelBn: 'নতুন কালেকশন', icon: Sparkles },
    { id: 'romantic' as CollectionTab, labelBn: 'Romantic Collection', icon: Heart },
    { id: 'rainy' as CollectionTab, labelBn: 'Rainy Love', icon: CloudRain },
    { id: 'letter' as CollectionTab, labelBn: 'Vintage Letter', icon: Mail },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-8 gap-4">
          ...
          <button
            ...
            className="text-xs sm:text-sm text-[#d4af37] hover:text-[#fef08a] flex items-center gap-1.5 font-bengali transition-colors cursor-pointer self-start md:self-auto"
          >
            <span>সকল পোস্টার লাইব্রেরি ({postcards.length})</span>
          ...
          {tabs.map((tab) => {
            ...
            return (
              <button
                ...
                className={`px-4 py-2 rounded-xl text-xs sm:text-sm font-bengali font-semibold flex items-center gap-2 transition-all cursor-pointer whitespace-nowrap ${
                  isCurrent
